...
public:
   ...
   // TBinaryTreeItem(const std::shared_ptr<T> obj);
    //TBinaryTreeItem(const std::shared_ptr<T> obj, std::shared_ptr<TBinaryTreeItem<T>> p);
    TBinaryTreeItem(std::shared_ptr<T> obj, std::shared_ptr<TBinaryTreeItem<T>> l, std::shared_ptr<TBinaryTreeItem<T>> r, std::shared_ptr<TBinaryTreeItem<T>> p);
